  ...
  async (_, {rejectWithValue}) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.message || 'Failed to play spin',
      );
    }
  },
);
...
export const purchaseSpin = createAsyncThunk(
  'spin/purchaseSpin',
  async (spinQuantity, {rejectWithValue}) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.message || 'Failed to purchase spin',
      );
    }
  },
);
...
export const getSpinLogs = createAsyncThunk(
  ...
  async (_, {rejectWithValue}) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.message || 'Failed to load spin logs',
      );
    }
  },
);
...
export const getSpinPrizeList = createAsyncThunk(
  ...
  async (_, {rejectWithValue}) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.message || 'Failed to load spin prize list',
      );
    }
  },
);
...
export const getSpinCount = createAsyncThunk(
  ...
  async (_, {rejectWithValue}) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.message || 'Failed to fetch spin count',
      );
    }
  },
);
  ...
  extraReducers: builder => {
    builder
      ...
      .addCase(getSpinCount.fulfilled, (state, action) => {
        ...
        // previously: state.spinCount = action.payload;
        state.spin = action.payload.spin; // full object now
      })
